...
namespace TRIGGERSand_CO
{
     ...
     */
        [SerializeField] int colorChangeInterval = 1;
        // Variable for storing data type of Light (component) 
        ...
        int frameCount =
            0; // Variable used to pause color changes in Light for the frame count specified with colorChangeInterval
